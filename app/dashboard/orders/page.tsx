...
const statusActions: Record<string, { label: string; next: OrderStatus } | null> = {
  pending: null,
  funded: { label: "Start Preparing", next: "preparing" },
...
export default function OrdersPage() {
  ...
  const loadOrders = useCallback(async () => {
    ...
    // In a production app we'd have a dedicated endpoint for restaurant orders
    // For now, fetch all orders and they'll be filtered server-side
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-forkit-dark">Orders</h1>
