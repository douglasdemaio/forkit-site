...
export default function OrderPage() {
  ...
  if (error || !order) {
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <h1 className="mt-6 text-2xl font-bold">{t("notFound")}</h1>
        <p className="mt-2 text-gray-500">{error || t("notFoundDesc")}</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      {/* Funding progress */}
      <div className="card p-5 mb-6">
        <h2 className="font-semibold text-gray-900 mb-3">{t("funding")}</h2>
        <FundingBar
